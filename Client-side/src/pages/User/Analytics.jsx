...
// Key Metrics Data
const metrics = [
  { name: 'Total Views', value: '1,247', change: '+14.5%', trend: 'up', icon: EyeIcon },
  { name: 'Profile Views', value: '89', change: '+7.8%', trend: 'up', icon: UserGroupIcon },
  { name: 'Listing Views', value: '1,158', change: '+12.4%', trend: 'up', icon: BuildingStorefrontIcon },
  { name: 'Avg. Rating', value: '4.6', change: '+0.3%', trend: 'up', icon: StarIcon },
];

// Listing Performance Data
const listingPerformance = [
  { name: 'The Coffee House', views: 456, reviews: 12, rating: 4.8, growth: '+24%' },
  { name: 'Tech Solutions Inc', views: 234, reviews: 6, rating: 4.5, growth: '+18%' },
...
const ListingPerformanceTable = () => (
  <div className="bg-white rounded-lg shadow">
    <div className="p-6">
      <h3 className="text-lg font-medium text-gray-900 mb-4">Listing Performance</h3>
          ...
          <tbody className="divide-y divide-gray-200">
            {listingPerformance.map((listing, index) => (
              <tr key={index}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-green-600">{listing.growth}</td>
              </tr>
            ))}
          </tbody>
        </table>
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Monthly Views (2025)</h3>
          <div className="h-64">
            <Bar
              data={{
                labels,
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Monthly Reviews (2025)</h3>
          <div className="h-64">
            <Bar
              data={{
                labels,
